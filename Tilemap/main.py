...
spritesheet = Spritesheet('map_tiles.png')
# player_img = spritesheet.parse_sprite('tree.png')
...
while running:
    ...
    canvas.fill((240, 240, 240)) # Fills the entire screen with light blue
    map.draw_map(canvas)
